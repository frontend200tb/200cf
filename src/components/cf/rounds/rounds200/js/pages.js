...
import in107     from '../p200/elem-107-Round83';
import in108     from '../p200/elem-108-Round83';
import in109     from '../p200/elem-109-Round84';
      ...
      if (pages[index]) {
        if (pages[index].length === 2) {
          ...
          switch (pages[index][1]) {
            ...
            case 107: in107(); break;
            case 108: in108(); break;
            case 109: in109(); break;
